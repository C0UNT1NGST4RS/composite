    ...
    theme: {
        extend: {
            ...
            backgroundImage: {
                ...
                delbin: "linear-gradient(to bottom,rgba(0, 0, 0, 0.30),rgba(0, 0, 0, 0.30)),url(../src/media/images/Heads/DelbinGeorge.jpg)",
                anvisha:
                    "linear-gradient(to bottom,rgba(0, 0, 0, 0.30),rgba(0, 0, 0, 0.30)),url(../src/media/images/Heads/Anvisha.jpg)",
                ashwin: "linear-gradient(to bottom,rgba(0, 0, 0, 0.30),rgba(0, 0, 0, 0.30)),url(../src/media/images/Heads/AshwinKV.jpeg)",
                joel: "linear-gradient(to bottom,rgba(0, 0, 0, 0.30),rgba(0, 0, 0, 0.30)),url(../src/media/images/Heads/JoelJames.jpg)",
                sonal: "linear-gradient(to bottom,rgba(0, 0, 0, 0.30),rgba(0, 0, 0, 0.30)),url(../src/media/images/Heads/Sonal.jpg)",
                lishma: "linear-gradient(to bottom,rgba(0, 0, 0, 0.10),rgba(0, 0, 0, 0.10)),url(../src/media/images/Heads/Lishma.jpg)",
                laniel: "linear-gradient(to bottom,rgba(0, 0, 0, 0.40),rgba(0, 0, 0, 0.40)),url(../src/media/images/Heads/Laniel.jpg)",
                frank: "linear-gradient(to bottom,rgba(0, 0, 0, 0.40),rgba(0, 0, 0, 0.40)),url(../src/media/images/Heads/Frank.jpg)",
                deepak: "linear-gradient(to bottom,rgba(0, 0, 0, 0.40),rgba(0, 0, 0, 0.40)),url(../src/media/images/Heads/Deepak.jpg)",
                bushan: "linear-gradient(to bottom,rgba(0, 0, 0, 0.40),rgba(0, 0, 0, 0.40)),url(../src/media/images/Heads/Bushan.jpg)",
                mahima: "linear-gradient(to bottom,rgba(0, 0, 0, 0.40),rgba(0, 0, 0, 0.40)),url(../src/media/images/Heads/Mahima.jpg)",
                // neha: "linear-gradient(to bottom,rgba(0, 0, 0, 0.40),rgba(0, 0, 0, 0.40)),url(https://images.unsplash.com/photo-153452811741775-53994a69daeb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8UG9ydHJhaXR8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60)",
                neha: "linear-gradient(to bottom,rgba(0, 0, 0, 0.40),rgba(0, 0, 0, 0.40)),url(https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80)",
